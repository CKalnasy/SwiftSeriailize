...
To deserialize a custom class (or struct), you must create initializers in the same manor as they are in /SwiftSerialize/Initializer.swift.
Work is in progress to have the entire Initializer class generated by a script.

Since the SwiftSerialize module needs to create instances of custom Swift classes, 
